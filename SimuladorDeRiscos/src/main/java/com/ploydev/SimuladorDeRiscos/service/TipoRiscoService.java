...
public class TipoRiscoService {
    ...
    public TipoRisco criarTipoRisco(TipoRisco tipoRisco) throws Exception {
        TipoRisco tipoExistente = tipoRiscoRepository.findByNivelRisco(tipoRisco.getNivelRisco());
    ...
    public TipoRisco buscarPorNivel(NivelRiscoEnum nivelRisco) {
    ...
    public TipoRisco desativarTipoRisco(UUID id) {
    ...
    public TipoRisco ativarTipoRisco(UUID id) {
        TipoRisco tipoRisco = tipoRiscoRepository.findById(id)
                .orElseThrow(() -> new RuntimeException("Tipo risco com id" + id + "não encontrado"));
